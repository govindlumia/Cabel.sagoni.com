...
public partial class Report_Month_Payment : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            ...
            grdLead.DataSource = obj_cable.Payment_select_Report(obj_cable);
            grdLead.DataBind();
    ...
    protected void btnExcell_Click(object sender, EventArgs e)
    {
        ...
        obj_cable.Payment_select_Report(obj_cable);
    ...
    {
        string attachment = "attachment; filename=MonthlyPayment_Report.xls";
