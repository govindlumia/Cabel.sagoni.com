<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="generate_branch.aspx.cs" Inherits="generate_branch" %>
...
<table width="100%" cellpadding="0" cellspacing="0" class="big" >
   ...
   <tr>
    ...
    <td valign="middle" class="cellInfo"><asp:TextBox ID="Txtbranchname" runat="server" CssClass="textbox" ></asp:TextBox></td>
   
   <td valign="middle" class="dvtCellLabel">Address: </td>
   <td valign="middle" class="cellInfo" >
   <asp:TextBox ID="txtadd" runat="server" CssClass="textbox"  TextMode="MultiLine" Height="50px"></asp:TextBox>
     </td>
   </tr>
   ...
   <tr>
    ...
    <asp:TextBox ID="Txt_Email" runat="server"  CssClass="textbox" ></asp:TextBox></td>
