...
public partial class NOC_ViewNOC : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            ...
            grdLead.DataSource = obj_cable.NOC_select(obj_cable);
            grdLead.DataBind();
        }
    }
    protected void grdLead_RowCommand(object sender, GridViewCommandEventArgs e)
    {
        if (e.CommandName == "Edit")
        {
            ...
            Response.Redirect("~/NOC/NOC_Entry.aspx?s_no=" + lblserialno.Text);
        ...
        if (e.CommandName == "Print")
        {
            ...
            GridViewRow row = (GridViewRow)(((ImageButton)e.CommandSource).NamingContainer);
            Label lblserialno = (Label)row.FindControl("lblserialno");
            Response.Redirect("~/sale_invoice.aspx?s_no=" + lblserialno.Text);
